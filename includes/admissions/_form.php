    ...
    <div class="inner bg-container ">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div id="rootwizard_no_val">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item user2 m-t-15">
                                    <a class="nav-link profile_details" href="#tab21" data-toggle="tab"><span class="profile_tab">2</span>Profile details</a>
                                </li>
                ...
                <input class="btn btn-primary layout_btn_prevent next" type="submit" name="create_post" value="Publish Post">                                            
